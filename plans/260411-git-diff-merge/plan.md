...
| 03 | phase-03-diff-viewer.md | DONE | 1d | Monaco DiffEditor integration with hunk rollback |
| 04 | phase-04-merge-conflict-ui.md | DONE | 1.5d | 3-way merge conflict resolution editor |
