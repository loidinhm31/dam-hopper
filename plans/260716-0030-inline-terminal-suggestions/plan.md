...
|---|---|---|---:|---:|---|
| 1 | Security containment + history privacy | Pending | 0% | 8h | [Phase 01](./phase-01-security-containment-and-history-privacy.md) |
...
- [ ] Before implementation, revise Phase 01 purge language to no automatic deletion.
- [ ] User clears legacy storage before relying on new privacy guarantees.
