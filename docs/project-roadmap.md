...
- **Plan status: IN PROGRESS (1/3 phases; 33%; updated 2026-09-21).** Phase 01 is complete; Phases 02 and 03 remain pending.
...
- **Validation:** Focused Windows asset-gate coverage passed **23/23 assertions**; deterministic package-twice verification passed; Node release-script syntax verification passed; code review approved **9.5/10** with no critical issues. See the [Phase 01 plan](../plans/260920-2327-windows-release-asset-and-installer/phase-01-asset-schema-and-packaging.md), [code review](../plans/reports/code-review-260921-0122-phase01-windows-release-asset-packaging.md), and [parent plan](../plans/260920-2327-windows-release-asset-and-installer/plan.md).
- **Next:** Phase 02 — PowerShell installer and harness, consuming the finalized Windows asset names and profile contracts. Phase 03 follows with CI publication and release guidance.
...
- **Phase 03 — Host Resource popover integration — DONE (2026-09-20; 100%; 6/6h):** Integrated the Fleet Deck and profile pills into the existing Host Resource popover while preserving single-profile behavior, owner-bound drilldown, per-profile acknowledgement, connected-only 1s metrics polling, focus restoration, disconnect/removal fallback, and selected-profile force-sleep labels. Focused popover tests passed **8/8**, the Host organism suite passed **178/178**, and the UI TypeScript build passed. See the [Phase 03 plan](../plans/260920-0137-multi-profile-host-resources/phase-03-host-resource-popover-integration.md), [code review](../plans/reports/code-review-260920-1044-phase03-host-resource-popover.md), and [parent plan](../plans/260920-0137-multi-profile-host-resources/plan.md).
- **Phase 04 — Verification and testing — DONE (2026-09-20; 100%; 4/4h):** Focused unit/component and Chromium validation passed **102/102** tests (83 unit/component; 19 browser), with TypeScript checking clean. Coverage defends watch scope, owner/generation isolation, tiered polling, unread partitioning, single-profile compatibility, accessibility, responsive layout, and security negatives. See the [Phase 04 plan](../plans/260920-0137-multi-profile-host-resources/phase-04-verification-and-testing.md), [tester report](../plans/reports/tester-260920-1130-phase04-multi-profile-host-resources.md), and [code review](../plans/reports/code-review-260920-1132-phase04-verification-and-testing.md).
- **Next:** Parent feature plan complete; deferred formatter, lint, broad build, and project-wide test gates remain with the integration owner.
...
- **Phase 05 — Agents, ports and Browser — DONE (2026-09-17; 100%):** Delivered owner-qualified agent catalogs/imports/memory drafts and same-owner distribution; qualified port/tunnel rows; explicit Browser target revision, lease and trust invalidation; owner-local capability availability; and same-owner terminal artifact capture with server-enforced incarnation-safe PTY handoff. See the [Phase 05 plan](../plans/260916-2137-unified-profile/phase-05-agents-ports-and-browser.md), [QA report](../plans/reports/qa-260917-1517-phase-05-agents-ports-browser-validation.md), and [Cycle 2 review](../plans/reports/code-review-260917-1522-phase-05-cycle2.md).
- **Phase 06 — Preferences, Settings, usage and host resources — DONE (2026-09-17; 100%):** Delivered independent preference source and Settings target selectors, captured owner/generation debounce and import transactions, profile-qualified usage queries/deep links, profile-isolated host metrics/alerts, owner-local pinned mounts, and revision-fenced force-sleep confirmation. See the [Phase 06 guide](./phase-06-preferences-settings-usage-and-host.md), [Phase 06 plan](../plans/260916-2137-unified-profile/phase-06-preferences-settings-usage-and-host.md), and [parent plan](../plans/260916-2137-unified-profile/plan.md).
- **Phase 07 — Media isolation and encryption — DONE (2026-09-17; 100%):** Delivered UUIDv4-namespaced media sessions, ticket-bound native image/video streams, fail-closed duplicate-cookie parsing, generation-safe remote cleanup, and owner-qualified encrypted writes with one captured transport. See the [Phase 07 guide](./phase-07-media-isolation-and-encryption.md), [Phase 07 plan](../plans/260916-2137-unified-profile/phase-07-media-isolation-and-encryption.md), and [parent plan](../plans/260916-2137-unified-profile/plan.md).
- **Phase 08 — Native scope concurrency and platform integration — DONE (2026-09-17; 100%):** Delivered concurrent admitted SSH scopes with scoped teardown, atomic Tauri IPC/model/permission cutover, explicit per-scope host/context state, and one Browser lease. Focused Linux validation passed **135/135** across shared/native/UI Vitest and native Cargo tests; Windows-only S13 traffic, DPAPI/WebView2 runtime proof remains unverified and blocks native release qualification only. See the [Phase 08 plan](../plans/260916-2137-unified-profile/phase-08-native-scope-concurrency.md), [tester report](../plans/reports/tester-260917-2012-phase-08-native-scope-concurrency.md), and [post-fix code review](../plans/reports/code-review-260917-2014-phase-08-native-scope-concurrency.md).
- **Phase 09 — Integration and qualification — DONE (2026-09-17; 100%):** Completed the unified multi-profile workbench release cutover. The reconciled qualification ledger records **3,504 tests passed** (9 skipped/ignored) across Rust, UI, browser, shared, bridge, native, live-harness, and embedded-browser suites; live dual-server S01–S12 assertions passed **24/24**; Cycle 2 review approved **9.8/10**. Web and Linux qualification are complete; Windows S13 remains a separately tracked native-platform follow-up. See the [Phase 09 plan](../plans/260916-2137-unified-profile/phase-09-integration-and-qualification.md), [verification matrix](../plans/260916-2137-unified-profile/verification-matrix.md), [tester report](../plans/reports/tester-260917-2156-phase09-integration-qualification.md), and [Cycle 2 review](../plans/reports/code-review-cycle2-260917-2307-phase09-integration.md).
- **Validation:** Phase 09 qualification passed **3,504 tests** with **0 failures**, live dual-server S01–S12 **24/24**, and Cycle 2 review approval **9.8/10**. Phase 08 focused evidence remains **135/135 passed on Linux**; Windows S13 is explicitly tracked as a native-platform follow-up.
...
- **Phase 02 — Service and REST API [COMPLETED / DONE 2026-09-02]**: Delivered current-workspace/profile-scoped WorkflowService and protected Axum REST API with target ownership validation, Plan-first hierarchy rules, strict DTO/error boundaries, idempotent request replay, optimistic concurrency, manual timestamp/harness-link contracts, keyset event pagination, and bounded retention/purge. Validation: workflow unit tests 14/14, API integration tests 8/8, full server suite 896/896 executed tests (2 ignored); review approved 9.5/10. [Test report](../plans/reports/tester-260902-0306-workflow-service-rest-api.md) · [Review report](../plans/reports/code-reviewer-260902-0312-phase-02-workflow-service-rest-api.md) · [Workflow tracking plan](../plans/260901-0919-workflow-tracking-notes/plan.md).
- **Phase 03 — Terminal lifecycle correlation and agent adapter [COMPLETED / DONE 2026-09-02]**: Added the closed `WorkflowObservation` contract and clone-cheap PTY recorder. A bounded `sync_channel(256)` and worker keep workflow SQLite off PTY input/output/restart hot paths; queue/storage failures are counted or logged without blocking terminals. Observations exclude command lines, arguments, CWD, environment, prompts, and output.
- Terminal links now track incarnation-ordered `attached`, `stale`, `exited`, `crashed`, and `detached` states. Final exit/removal may expose a suggested end time, but never changes manual session status, `startedAt`, or `endedAt`; direct Plan sessions remain valid without synthetic Phase/Task records.
- Startup restores PTYs first, then reconciles persisted terminal links against live `(sessionId, incarnation)` identities. Agent resources remain bounded manual links (`harnessLabel` ≤64 characters, `runId` ≤128); no automatic harness producer or generic observation endpoint is shipped.
- Validation: Phase 03 review reports 28 workflow tests and 907 full-server tests passing; review approved 9.8/10. [Code review](../plans/reports/code-reviewer-260902-0420-phase-03-terminal-lifecycle-correlation.md) · [Workflow API](./workflow-api.md).
- **Phase 04 — Client types, transport, and query state [COMPLETED / DONE 2026-09-02]**: Delivered strict shared-UI workflow DTOs and domain helpers, all 13 protected REST operation mappings, profile/transport-generation-isolated React Query hooks, mutation invalidation and request-ID replay handling, and manual timestamp/resource-observation helpers without changing terminal navigation or localStorage state.
- Validation: Targeted Phase 04 UI tests 51/51, full UI suite 1,452/1,452, and Rust server 907/907 executed tests passed (2 ignored); code review approved 10/10. [Test report](../plans/reports/tester-260902-1139-phase-04-client-types-transport-query-state.md) · [Review report](../plans/reports/code-reviewer-260902-1144-phase-04-client-types-transport-query-state.md) · [Phase plan](../plans/260901-0919-workflow-tracking-notes/phase-04-client-types-transport-and-query-state.md).
- **Phase 05 — Responsive workflow context surface [COMPLETED / DONE 2026-09-02]**: Delivered the Plan-first workflow context surface with an ambient ribbon, responsive desktop deck, mobile segmented safe-area sheet, optional Phase/Task capture, direct notes/sessions/execution links, manual timestamp/**Now** controls, observed terminal suggestions, focus-safe shortcut ownership, and loading/error/empty states.
- Validation: targeted Phase 05 UI tests passed 62/62 (100%); full UI suite passed 1,493/1,493 (100%); Rust server executed tests passed 907/907 (2 ignored). Review approved 9.8/10. Responsive browser geometry, safe-area, and terminal/editor continuity validation were completed in Phase 07. [Test report](../plans/reports/tester-260902-1243-phase-05-responsive-workflow-context-surface.md) · [Review report](../plans/reports/code-reviewer-260902-1245-phase-05-responsive-workflow-context-surface.md) · [Phase plan](../plans/260901-0919-workflow-tracking-notes/phase-05-responsive-workflow-context-surface.md).
- **Phase 06 — WorkspacePage and shell integration [COMPLETED / DONE 2026-09-02; 100%]**: Mounted one Plan-first `WorkflowContextSurface` through the existing `toolbarActions` seams across IDE, terminal, and mobile shells. Reused authoritative terminal and project-target navigation; workflow observations remain read-only, profile-isolated, and separate from terminal/editor/browser-debug state. No route or search-parameter changes. Validation: targeted UI 62/62, full UI 1,515/1,515, relevant Chromium smoke 8/8, Rust 907/907 executed (2 ignored), UI package compilation passed; review approved 9.8/10. Phase 07 verification, rollout, observability, and documentation gates are complete below. [Test report](../plans/reports/tester-260902-1430-phase-06-workspace-page-and-shell-integration.md) · [Review report](../plans/reports/code-reviewer-260902-1440-phase-06-workspace-page-and-shell-integration.md) · [Phase plan](../plans/260901-0919-workflow-tracking-notes/phase-06-workspace-page-and-shell-integration.md).
- **Phase 07 — Verification, rollout, observability, and docs [COMPLETED / DONE 2026-09-02; 100%]**: Completed migration/restart/rollback rehearsal, privacy-safe bounded `DiagnosticStore` instrumentation, old-server compatibility, browser continuity, and release documentation. Migration 010 remains additive; rollback retains workflow tables/data and older binaries ignore them.
- Fixed-cardinality diagnostics cover `workflow_operation_duration_seconds`, `workflow_queue_dropped_total`, `workflow_reconciliation_total`, and `workflow_storage_errors_total`; labels and counts are bounded and exclude IDs, projects, paths, notes, commands, CWD, environment, prompts, and output. A profile-scoped HTTP 404 from `/api/workflow/overview` maps to feature-unavailable, suppresses query retries, and hides workflow controls; 401/5xx failures remain explicit errors. Keyboard/focus contracts preserve terminal/editor ownership, return focus on Escape, enforce 44px controls, safe-area/35–90dvh sheets, reduced motion, and no horizontal overflow.
- Validation: Rust focused gates **134/134 passed** (one PTY test ignored), focused UI Vitest **122/122 passed** across 13 files, and real-server Chromium browser **4/4 passed** against the actual no-auth backend. [Phase 07 plan](../plans/260901-0919-workflow-tracking-notes/phase-07-verification-rollout-observability-and-docs.md) · [Workflow API](./workflow-api.md) · [Workflow surface browser test](../packages/ui/browser-tests/workflow-context-surface.browser.tsx) · [Terminal continuity browser test](../packages/ui/browser-tests/workspace-workflow-terminal-continuity.browser.tsx).
...
- **Phase 04:** DONE — terminals, workflow and owner-directed navigation complete (2026-09-17; 100%).
- **Phase 05:** DONE — agents, ports and Browser, capability isolation and incarnation-safe handoff complete (2026-09-17; 100%).
...
- **Phase 08:** DONE — native scope concurrency and platform integration complete (2026-09-17; 100%); Linux focused validation 135/135. Windows S13 runtime evidence remains a separately tracked native-platform follow-up.
- **Phase 09:** DONE — integration and qualification complete (2026-09-17; 100%); 3,504 tests passed, live S01–S12 24/24, Cycle 2 review 9.8/10. Windows S13 remains a separately tracked native-platform follow-up.
- **Plan progress:** 10/10 phases complete (100%); unified multi-profile workbench release cutover complete.
