...
(2026-09-06). Release manager Phase 02 helper-unit staging is complete.
Validation evidence: Rust idle-suspend integration 81/81, UI Vitest 3/3,
Chromium browser 10/10, non-privileged boundary verifier 12/12, and `cargo
check` passed.
...
**Generated by**: Repomix v1.18.0 snapshot (1,756 files / 3,659,571 tokens /
14,858,183 characters). Five security-flagged files were excluded from the
