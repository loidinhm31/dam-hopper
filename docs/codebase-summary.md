...
sweep, and one-idle-session pressure eviction protect lifecycle admission. The
authenticated semantic WebSocket, document sync/navigation, and client adapter
...
**Phase Status**: Semantic LSP Phase 2 remediation approved; Phase 3 transport and Phase 5 release qualification remain pending
