  ...
  return (
    <AppLayout title="Settings">
      <div className="max-w-3xl space-y-10">
        <section>
          <h2 className="text-lg font-semibold text-[var(--color-text)] mb-4">Global Settings</h2>
          <GlobalConfigEditor />
        </section>

        <section>
          <h2 className="text-lg font-semibold text-[var(--color-text)] mb-4">Workspace Config</h2>
          {isLoading && (
