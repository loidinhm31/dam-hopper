...
function getMimeDecoration(mime?: string): FileDecoration | null {
  ...
  if (normalizedMime === "application/json" || normalizedMime.endsWith("+json"))
    return EXTENSION_DECORATIONS.json;
  ...
  if (
    ...
    return EXTENSION_DECORATIONS.xml;
  if (
    normalizedMime === "text/markdown" ||
    normalizedMime === "text/x-markdown"
  )
    return EXTENSION_DECORATIONS.md;
  if (normalizedMime === "text/rust" || normalizedMime === "application/rust")
    return EXTENSION_DECORATIONS.rs;
  if (
    normalizedMime === "text/x-python" ||
    normalizedMime === "application/x-python-code"
  )
    return EXTENSION_DECORATIONS.py;
  if (
    normalizedMime === "application/yaml" ||
    normalizedMime === "text/yaml" ||
    normalizedMime === "text/x-yaml"
  )
    return EXTENSION_DECORATIONS.yaml;
  if (normalizedMime === "application/toml" || normalizedMime === "text/toml")
    return EXTENSION_DECORATIONS.toml;
